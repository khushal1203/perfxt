  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <head>
        ...
        <noscript dangerouslySetInnerHTML={{ __html: `<img height="1" width="1" style="display:none" src="https://www.facebook.com/tr?id=1914651325815360&ev=PageView&noscript=1" />` }} />
      </head>
      <body>{children}</body>
    </html>
  );
