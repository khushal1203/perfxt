    ...
    <section className="process-wrapper" id="process">
      ...
      <div className="process-bottom">
        ...
        <div className="process-right-img">
          <Image src="/images/home/pcover.gif" alt="process cover" width={1215} height={1026} sizes="(max-width: 768px) 100vw, (max-width: 1440px) 50vw, 40vw" style={{ width: "100%", height: "auto" }} loading="lazy" />
        </div>
      </div>
    </section>
  );
